...
It has two main branches. These are main (here) and v2_025. Main is setup as in the GMD model description paper (https://doi.org/10.5194/gmd-17-3993-2024). V2_025 is setup as in this subsequent paper. 
So the note on differences. The essence is that main is setup for use in Earth System Model resolution (~1.5 degrees), whilst V2_025 is designed for use in ISIMIP & other impacts modelling protocols.
